...
from tdsxtract.helpers import *
from tdsxtract.io import *
from tdsxtract.optim import *
...
sample = Sample({"unknown": {"epsilon": 3.0, "mu": 1.0, "thickness": 500e-6},})

# T = get_transmission(sample, 100)
freqs = freqs_ref

freqs_restrict, index_min, index_max = restrict(freqs, x_min=0.2e12, x_max=1e12)
